...
class CSVDataTest(TestCase):
    def test_accounts(self):
        ...
        csv = Collector()
        self.assertEqual(len(csv.accounts), 0)
        self.assertEqual(csv.add(formatter), True)
        self.assertEqual(len(csv.accounts), 1)
        self.assertEqual(csv.add(formatter), False)
    ...
    def test_terms(self):
        ...
        csv = Collector()
        self.assertEqual(len(csv.terms), 0)
        self.assertEqual(csv.add(formatter), True)
        self.assertEqual(len(csv.terms), 1)
        self.assertEqual(csv.add(formatter), False)
        self.assertEqual(csv.has_data(), True)
    ...
    def test_admins(self):
        ...
        csv = Collector()
        self.assertEqual(len(csv.admins), 0)
        self.assertEqual(csv.add(formatter), True)
        self.assertEqual(len(csv.admins), 1)
        self.assertEqual(csv.has_data(), True)
    ...
    def test_courses(self):
        ...
        csv = Collector()
        self.assertEqual(len(csv.courses), 0)
        self.assertEqual(csv.add(formatter), True)
        self.assertEqual(len(csv.courses), 1)
        self.assertEqual(csv.add(formatter), False)
        self.assertEqual(csv.has_data(), True)
    ...
    def test_sections(self):
        ...
        csv = Collector()
        self.assertEqual(len(csv.sections), 0)
        self.assertEqual(csv.add(formatter), True)
        self.assertEqual(len(csv.sections), 1)
        self.assertEqual(csv.add(formatter), False)
        self.assertEqual(
            csv.add(SectionCSV(
                section_id='abc', course_id='abc', name='abc',
                status='active')), True)
        self.assertEqual(len(csv.sections), 2)
        self.assertEqual(csv.has_data(), True)
    ...
    def test_enrollments(self):
        ...
        csv = Collector()
        self.assertEqual(len(csv.enrollments), 0)
        self.assertEqual(
            csv.add(EnrollmentCSV(
                section_id='abc', person=user, role='Student',
                status='active')), True)
        self.assertEqual(len(csv.enrollments), 1)
        ...
        self.assertEqual(len(csv.enrollments), 3)
        ...
        self.assertEqual(len(csv.enrollments), 5)
        self.assertEqual(csv.has_data(), True)

        # Ad-hoc enrollment
        self.assertEqual(csv.add(EnrollmentCSV(
            course_id='course_123', section_id='section_123',
            person=user, role='Observer', status='active')), True)
        self.assertEqual(len(csv.enrollments), 6)
    ...
    def test_xlists(self):
        csv = Collector()
        self.assertEqual(len(csv.xlists), 0)
        self.assertEqual(csv.add(XlistCSV('abc', 'def')), True)
        self.assertEqual(len(csv.xlists), 1)
        self.assertEqual(csv.has_data(), True)
    ...
    def test_users(self):
        ...
        csv = Collector()
        self.assertEqual(len(csv.users), 0)
        self.assertEqual(csv.add(UserCSV(user, 'active')), True)
        self.assertEqual(len(csv.users), 1)
        self.assertEqual(csv.add(UserCSV(user, 'active')), False)
        self.assertEqual(csv.has_data(), True)
