...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Job'
        db.create_table(u'sis_provisioner_job', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('changed_by', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('changed_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('last_run_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('is_active', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'sis_provisioner', ['Job'])


        # Changing field 'Instructor.reg_id'
        db.alter_column(u'sis_provisioner_instructor', 'reg_id', self.gf('django.db.models.fields.CharField')(default='', max_length=32))
        # Adding unique constraint on 'Instructor', fields ['section_id', 'reg_id']
        db.create_unique(u'sis_provisioner_instructor', ['section_id', 'reg_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Instructor', fields ['section_id', 'reg_id']
        db.delete_unique(u'sis_provisioner_instructor', ['section_id', 'reg_id'])

        # Deleting model 'Job'
        db.delete_table(u'sis_provisioner_job')


        # Changing field 'Instructor.reg_id'
        db.alter_column(u'sis_provisioner_instructor', 'reg_id', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
    ...
    models = {
        ...
        u'sis_provisioner.instructor': {
            'Meta': {'unique_together': "(('section_id', 'reg_id'),)", 'object_name': 'Instructor'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reg_id': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'section_id': ('django.db.models.fields.CharField', [], {'max_length': '80'})
        },
        u'sis_provisioner.job': {
            'Meta': {'object_name': 'Job'},
            'changed_by': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'changed_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'last_run_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
