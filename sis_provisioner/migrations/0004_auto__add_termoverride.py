...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TermOverride'
        db.create_table(u'sis_provisioner_termoverride', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('course_id', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('term_sis_id', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('term_name', self.gf('django.db.models.fields.CharField')(max_length=24)),
            ('reference_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'sis_provisioner', ['TermOverride'])


    def backwards(self, orm):
        # Deleting model 'TermOverride'
        db.delete_table(u'sis_provisioner_termoverride')
    ...
    models = {
        ...
        u'sis_provisioner.termoverride': {
            ...
            'term_sis_id': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        },
