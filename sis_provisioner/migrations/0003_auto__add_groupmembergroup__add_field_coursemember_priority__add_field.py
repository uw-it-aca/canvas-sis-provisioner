...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupMemberGroup'
        db.create_table(u'sis_provisioner_groupmembergroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group_id', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('root_group_id', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('is_deleted', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'sis_provisioner', ['GroupMemberGroup'])

        # Adding field 'CourseMember.priority'
        db.add_column(u'sis_provisioner_coursemember', 'priority',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CourseMember.queue_id'
        db.add_column(u'sis_provisioner_coursemember', 'queue_id',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'GroupMemberGroup'
        db.delete_table(u'sis_provisioner_groupmembergroup')

        # Deleting field 'CourseMember.priority'
        db.delete_column(u'sis_provisioner_coursemember', 'priority')

        # Deleting field 'CourseMember.queue_id'
        db.delete_column(u'sis_provisioner_coursemember', 'queue_id')
