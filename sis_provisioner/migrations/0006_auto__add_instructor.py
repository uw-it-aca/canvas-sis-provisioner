...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sis_provisioner_instructor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('section_id', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('reg_id', self.gf('django.db.models.fields.CharField')(max_length=32, null=True)),
        ))
        db.send_create_signal(u'sis_provisioner', ['Instructor'])


    def backwards(self, orm):
        # Deleting model 'Instructor'
        db.delete_table(u'sis_provisioner_instructor')
