...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.changed_date'
        db.alter_column(u'sis_provisioner_job', 'changed_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Job.changed_date'
        db.alter_column(u'sis_provisioner_job', 'changed_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
