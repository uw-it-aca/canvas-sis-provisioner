...
$(document).ready(function () {
    ...
    function courseDataFromJSON(course) {
        ...
        return {
            ...
            archived_date: format_long_date(course.archived_date),
            archived_date_relative: format_relative_date(course.archived_date),
    ...
    function openCreateUserCourse() {
        ...
        course_name = net_id + ' ' +
            qtr.charAt(0).toUpperCase() + qtr.slice(1, 2) + year.slice(2, 4) +
            ' Course';
